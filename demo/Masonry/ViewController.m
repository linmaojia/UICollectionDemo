...
- (NSArray *)nameArray {
    ...
    if (!_nameArray) {
        _nameArray = @[@"Collection-1个区-1",@"Collection-多个分区-2",@"Collection-头部-3",@"分区头部自定义-跳的第五-4",@"Collection添加到table的cell上-5",@"Collection-横向-6",@"CollectionCell-按住移动-7",@"Collection-添加tableView-8",@""];
...
- (void)setNav {
    ...
    self.navigationItem.title = @"UI-组件";
